...
- R1 约等于 openai-o1： R1：复杂问题推理、数学/代码求解（学术研究、技术分析、代码开发）
- v3 约等于 GPT-4o： V3：多轮对话、指令理解、任务执行（客服、日常对话、内容生成）
...
| 工具/平台 | 类型             | 优势              | 主要用途                 | 典型用户           |
| :-------- | :--------------- | :---------------- | :----------------------- | :----------------- |
| PyTorch   | 深度学习框架     | 生态完善/研究友好 | 模型训练与部署           | 研究人员、工程师   |
| 硅基流动  | 国产深度学习框架 | 国产化/高性能计算 | 国产化替代、高性能计算   | 国内企业、政府项目 |
| DeepSeek  | 大模型公司       |                   | 提供开源 LLM 和 API      | 开发者、企业       |
| LangChain | LLM 应用框架     | 多模型支持/组件化 | 构建基于大模型的复杂应用 | 企业级 AI 应用开发 |
...
2. 最佳实践路径
   ...
   数据准备 → 2. 基座模型选择 → 3. RAG/微调 → 4. LangChain 集成 → 5. Agent 部署
