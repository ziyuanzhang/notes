...
## 大模型应用方向 分 2 类： RAG（检索增强生成）；微调（Fine-tuning）
...
客户端：个人【chatbox/Cherry-Studio】；公司网页【Open-WebUI】
...
| 工具/平台 | 类型             | 主要用途                 | 典型用户           |
| :-------- | :--------------- | :----------------------- | :----------------- |
| PyTorch   | 深度学习框架     | 模型训练与部署           | 研究人员、工程师   |
| 硅基流动  | 国产深度学习框架 | 国产化替代、高性能计算   | 国内企业、政府项目 |
| DeepSeek  | 大模型公司       | 提供开源 LLM 和 API      | 开发者、企业       |
| LangChain | LLM 应用框架     | 构建基于大模型的复杂应用 | AI 应用开发者      |
