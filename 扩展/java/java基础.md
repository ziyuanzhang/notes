...
![java类的栈与堆1](./img/java/java类的栈与堆1.png)
![java类的栈与堆2](./img/java/java类的栈与堆2.png)
...
- 特殊属性名:value
  ...
  如果注解中“只有一个 value 属性”，使用注解时，value 名称可以不写!!!
...
- 如何解析注解?
  ...
  2. 比如要解析类上面的注解，则应该先获取该类的 Class 对象，再通过 Class 对象解析其上面的注解。
